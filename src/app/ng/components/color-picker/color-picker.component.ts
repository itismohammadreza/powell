...
import {NgColorFormat, NgIconPosition, NgLabelPosition, NgSize, NgValidation} from '@ng/models';
...
export class ColorPickerComponent extends ConfigHandler implements OnInit, ControlValueAccessor {
  @Input() value: any;
  @Input() label: string;
