import {Component, forwardRef, Host, Input, OnInit, Optional, SkipSelf, ViewContainerRef} from '@angular/core';
...
export class DynamicElComponent implements OnInit, ControlValueAccessor {
  ...
  ngOnInit() {
    const cmpRef = this.vcRef.createComponent<any>(this.elements[this.config.type]);
