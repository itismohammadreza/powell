...
export const CALENDAR_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => JalaliDatepickerComponent2),
  multi: true
};
...
@Component({
  selector: 'ng-jalali-datepicker2',
...
export class JalaliDatepickerComponent2 implements OnInit, OnDestroy, ControlValueAccessor {
  @Input() style: any;
