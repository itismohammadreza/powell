...
@Component({
  ...
  imports: [TreeModule, ReactiveFormsModule, PreviewComponent],
})
export class TreePage extends PreviewBase {
  @ViewChild(TreeComponent) declare cmpRef: TreeComponent;
  ...
  override previewOptions: PreviewOption[] = [
    ...
    {
      field: 'labelPosition',
      selectOptions: 'fixLabelPositions',
      value: this.config.fixLabelPosition,
    },
    { field: 'addon', selectOptions: 'additions', value: 'none' },
