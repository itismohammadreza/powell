...
@Component({
  ...
  template: `
    <p-drawer [visible]="showDesigner" (visibleChange)="hide($event)" header="Drawer" header="Theme Designer"
              position="right" styleClass="designer !w-screen md:!w-[48rem]" [modal]="false" [dismissible]="false">
            ...
            <p-tabpanel value="0">
              ...
              <div class="flex flex-col">
                <div class="flex flex-col gap-4 border border-surface-200 dark:border-surface-700 rounded-md p-4">
                  ...
                  <p-selectbutton [ngModel]="selectedPreset()" (ngModelChange)="onPresetChange($event)"
                                  [options]="presetOptions" optionLabel="label" optionValue="value"
                                  [allowEmpty]="false"/>
                </div>
                ...
                <div
                  ...
                  <p-button label="Restore from local storage" styleClass="!px-3 !py-2" severity="secondary"
          ...
          @defer (when activeTab == '4') {
            <p-tabpanel value="4">
              ...
              <ul class="flex flex-col gap-4 list-none p-0 mx-0 my-4">
                <li *ngFor="let token of customTokens;let index = index"
                    class="first:border-t border-b border-surface-200 dark:border-surface-300 py-2">
                  <div class="flex items-center gap-4">
